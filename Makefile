.PHONY: blocknumber blocknumber-json update-stablecoins extract-wallet-data extract-wallet-data-90d extract-wallet-data-all-time extract-120 extract-with-fanout analyze-extractions
