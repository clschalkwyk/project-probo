...
export default function App() {
  ...
  const featureList = [
    ...
    ["tx_acceleration_ratio", "Tx acceleration (recent/baseline)"],
    ["tx_acceleration_flag", "Acceleration flag"],
                ...
                <section className="trust-panel">
                  <div className="panel-header">
                    ...
                    <div className="pill-row">
                      <div className="pill">
                        {payload.label ? `Trust band: ${payload.label}` : "Trust band: n/a"}
                      </div>
                    </div>
                  </div>
                  <div className="trust-grid">
                    <div>
                      <p className="muted">Trust signal</p>
                      <p className="stat">{payload.score ?? "n/a"}</p>
                      <p className="muted">
                        0-100 behavior signal. Higher suggests more trust.
                      </p>
                    </div>
                    <div>
                      <p className="muted">Behavior summary</p>
                      {payload.reasons?.length ? (
                        ...
                        <p className="muted">No behavior notes in this file.</p>
                      )}
                    </div>
                    {payload.infra && (
                      <div>
                        <p className="muted">Behavior pattern</p>
                        <p className="pill">
                        ...
                        {payload.infra.explain?.length ? (
                          ...
                          <p className="muted">No pattern highlights.</p>
                        )}
                      </div>
                    )}
                    <div>
                      <p className="muted">Behavior signals</p>
                      {payload.features ? (
              ...
              <div className="stats">
                <div>
                  ...
                  <span className="muted">
                    capped: {String(payload.transfers_truncated)}
                  </span>
                  {stats.sampled && (
                    <span className="muted">
                      sampled: {stats.sampleSize} / {stats.totalTransfers}
                    </span>
                  )}
                </div>
                <div>
